...
test_that("l_Darcy_friction_factor()", {
  ...
  expect_equal(glfMB:::l_Darcy_friction_factor_core(Re_lam[1], 0.0001, ID), 64/Re_lam[1])
  expect_equal(glfMB:::l_Darcy_friction_factor_core(Re_lam[2], 0.0001, ID), 64/Re_lam[2])
  
  
  # Turbulent flow
  Re_tur <- c(5000, 10^4, 10^5, 10^6)
  expect_equal(round(glfMB:::l_Darcy_friction_factor(Re_tur, 0.0001, ID), 4), c(0.0385, 0.0324, 0.0222, 0.0199))
})
