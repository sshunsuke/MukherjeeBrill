---
title: "Example code with MukherjeeBrill"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{MukherjeeBrill}
...
plot(Re, util_MB_Colebrook(Re, roughness, 1), type="l", log="xy", ylim=c(0.005,0.1), ylab="fD")
abline(h=0.02, lty=2)
